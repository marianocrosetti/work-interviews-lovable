...
It should be easy for us to run and test your assignment. 
`npm run`, `go run`, `docker compose` are all fine. Anything that doesn't require us to setup more tools is great.
